          ...
          {useExistingCustomer ? (
              ...
              <div>
                <div>
                  ...
                  <input type="text" name="fullName" value={newCustomer.fullName} onChange={handleNewCustomerChange} required />
                </div>
                <div>
                  <label>Email</label>
                  <input type="email" name="email" value={newCustomer.email} onChange={handleNewCustomerChange} required />
                </div>
                <div>
                  <label>Số điện thoại</label>
                  <input type="tel" name="phone" value={newCustomer.phone} onChange={handleNewCustomerChange} required />
                </div>
              </div>
          )}
